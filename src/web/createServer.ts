  ...
  app.get('/api/runs/:runId/report', async (request, reply) => {
    ...
    return {
      ...
      run: {
        ...
        status: run.status,
        executionModeLabel: run.executionModeLabel,
        runStatusLabel: run.runStatusLabel,
        accountsTotal: run.accountsTotal,
        accountsEnded: run.accountsEnded,
        accountsCompleted: run.accountsCompleted,
        accountsPartial: run.accountsPartial,
        accountsFailed: run.accountsFailed,
        accountsNotCompleted: run.accountsNotCompleted,
